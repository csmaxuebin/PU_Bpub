...
for file_id in [333]:
    ...
    if samplerate != 2:
        ...
        if file_id == 4:
            ...
            hashbit = 4
            samplerate = 0.1
            cluster_list = [att1_clique]
            # , att2_clique, att3_clique, att4_clique, att5_clique
        else:
            bloombit = 128
            hashbit = 4
            samplerate = 0.02
            cluster_list = [att2_clique, att3_clique, att4_clique]
        # ,
        # for f in [0.98,0.97,0.96]:
        for f in [0.1, 0.3, 0.5, 0.7, 0.9]:
            # ,0.7,0.75,0.82,0.88,0.94
            ...
            if file_id != 5:
                ...
                for each_k in cluster_list:
                    ...
                    for eachclique in each_k:
                        ...
                        some_list, pro2 = independent_marginal2(eachclique, bit_list3, bit_cand_list3, rowlist2,
                                                                bitsum_list3, f, dt)
                        ...
                        print(write_list1)
                        os.chdir('C:\Users\\28708\\Desktop\\DisHD\\output2')
                        with open('file-' + str(file_id) + 'true_pro_marginal.csv', 'a') as fid:
                        ...
                        sum_err2 += err2
                        print(i,  err2, etime1, etime2, etime3, eachclique)
                        # print(err_list1)
                    ...
                    # print ("len(each_k)", len(each_k))
                    print(lenk,  mean_err2,  mean_time1, mean_time2, mean_time3)
                    write_list = [
                        [f, samplerate, lenk,  mean_err2, mean_time1, mean_time2, mean_time3,
                         sparse_rate, bloombit, hashbit]]
                    print(write_list)
                    os.chdir('C:\Users\\28708\\Desktop\\DisHD\\output2')
